  ...
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <%--    <li><a class="add" href="user_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>--%>
          <li><asp:LinkButton ID="btnAudit" runat="server" CssClass="lock" OnClientClick="return ExePostBack('btnAudit','审核通过后党员正常使用，是否继续？');" onclick="btnAudit_Click"><i></i><span>审核通过</span></asp:LinkButton></li>
        </ul>
      </div>
      <div class="r-list">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="20%">支部名称</th>
    <th align="left" width="12%">手机</th>
    <th align="left" width="20%">邮箱</th>
   <%-- <th width="8%">余额</th>
    <th width="8%">积分</th>--%>
    <th width="8%">状态</th>
  </tr>
...
<FooterTemplate>
  <%#rptList.Items.Count == 0 ? "<tr><td align=\"center\" colspan=\"8\">暂无党员需要审核</td></tr>" : ""%>
</table>
</FooterTemplate>
</asp:Repeater>
</div>
