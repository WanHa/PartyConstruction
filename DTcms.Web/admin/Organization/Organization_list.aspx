<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organization_list.aspx.cs" Inherits="DTcms.Web.admin.Organization.Organization" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="Organization_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            <th width="10%">选择</th>
                            <th align="left" width="20%">党支部</th>
                            <th align="left" width="20%">父级</th>
                            <th align="left" width="20%">党委书记</th>
                            <th align="left" width="20%">支部位置</th>
                            <th width="10%">操作</th>
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("manager")%></td>
                        <td><%#Eval("position")%></td>
                        <td align="center"><a href="Organization_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("Id")%>">修改</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
