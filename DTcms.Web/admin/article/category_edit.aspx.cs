...
namespace DTcms.Web.admin.article
{
    public partial class category_edit : Web.UI.ManagePage
    {
        ...
        {
            //this.qiniu_domain = ConfigurationManager.AppSettings["QiNiuRootUrl"].ToString();
            //string AK = ConfigurationManager.AppSettings["QiNiuAk"].ToString();
            //string SK = ConfigurationManager.AppSettings["QiNiuSk"].ToString();
        ...
        private bool DoAdd()
        {
            try
            {
                ...
                model.img_url = txtImage.Text.Trim();
