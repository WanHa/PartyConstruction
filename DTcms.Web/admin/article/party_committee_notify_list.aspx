<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="party_committee_notify_list.aspx.cs" Inherits="DTcms.Web.admin.article.party_committee_notify_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="party_committee_notify.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
...
<%--      <th align="left" width="120">属性</th>--%>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><a href="party_committee_notify.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
     ...
     <%-- </td>--%>
      <td align="center">
        <a href="party_committee_notify.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
      ...
      <li>
        <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
         ...
         <%#Eval("img_url").ToString() != "" ? "<div id=\"cover\" class=\"pic\" ><img src=\"../skin/default/loadimg.gif\" data-original=\"" + Eval("img_url") + "\" /></div><i class=\"absbg\"></i>" : ""%>
          <h1><span><a href="party_committee_notify.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></span></h1>
          <div class="remark">
         ...
         <%-- <div class="tools"> 
          ...
          <div class="foot">
            ...
            <a href="party_committee_notify.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
          </div>
        </div>
      </li>
  </ItemTemplate>
