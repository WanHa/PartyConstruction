...
{
    public partial class party_committee_notify : Web.UI.ManagePage
    {
        ...
        //            case "video": //视频上传
        //                          //goto case "single-text";
        //                HtmlGenericControl upload_div = new HtmlGenericControl("div");
        //                upload_div.Attributes.Add("id", "qiniu_vedio");
        //                HtmlGenericControl videoSelectFile = new HtmlGenericControl("input");
        //                videoSelectFile.Attributes.Add("type", "button");
        //                videoSelectFile.Attributes.Add("id", "vedio_file");
        //                videoSelectFile.Attributes.Add("style", "width: 100px");
        //                videoSelectFile.Attributes.Add("value", "选择文件");
        //                upload_div.Controls.Add(videoSelectFile);
        //                HtmlGenericControl videoUpload = new HtmlGenericControl("input");
        //                videoUpload.Attributes.Add("type", "button");
        //                videoUpload.Attributes.Add("id", "vedio_up_load");
        //                videoUpload.Attributes.Add("style", "width: 100px; margin-left:5px;");
        //                videoUpload.Attributes.Add("value", "确认上传");
        //                upload_div.Controls.Add(videoUpload);

        //                HtmlGenericControl info_div = new HtmlGenericControl("div");
        //                HtmlGenericControl progress_table = new HtmlGenericControl("table");
        //                progress_table.Attributes.Add("id", "progress_table");
        //                progress_table.Attributes.Add("display", "none");
        //                progress_table.Attributes.Add("class", "table table-striped table-hover text-left");
        //                progress_table.Attributes.Add("style", "width:450px");
        //                HtmlGenericControl videotbody = new HtmlGenericControl("tbody");
        //                videotbody.Attributes.Add("id", "vedioUploadProgress");
        //                progress_table.Controls.Add(videotbody);
        //                HtmlGenericControl data_table = new HtmlGenericControl("table");
        //                data_table.Attributes.Add("id", "data_table");
        //                info_div.Controls.Add(progress_table);
        //                info_div.Controls.Add(data_table);
        //                htmlDD.Controls.Add(upload_div);
        //                htmlDD.Controls.Add(info_div);
        //                break;
        //            case "number": //数字
        //                goto case "single-text";
        //            case "checkbox": //复选框
        ...
        //            case "video": //视频上传
        //                          //goto case "single-text";
        //                video_count = model.video.Count;
        //                string videoHtmlStr = "";
        //                for (int i = 0; i < model.video.Count; i++)
        //                {
        //                    P_Video item = model.video[i];
        //                    videoHtmlStr += "<tr><td>第" + (i + 1) + "课</td><td><input name='video_name' readonly='true' style='border: 0px;' value='" +
        //                         item.P_VideoName + "' /></td><td>视频地址：<input input name='video_url' readonly='true' style='width: 300px;border: 0px;' value='" +
        //                         item.P_Url + "' /></td>"
        ...
        //                }
        //                this.video_str.Value = videoHtmlStr;
        //                break;
        //            case "number": //数字
        //                goto case "single-text";
        //            case "checkbox": //复选框
        ...
        //    model.user_id = GetAdminInfo().id; // 获取当前登录用户ID
        ...
        //    #region 添加视频==============
        //    string[] video_name = Request.Form.GetValues("video_name");
        //    string[] video_url = Request.Form.GetValues("video_url");
        //    string[] video_length = Request.Form.GetValues("video_length");
        //    if (video_name != null && video_name.Length > 0 && video_url != null && video_url.Length > 0)
        //    {
        //        List<P_Video> video = new List<P_Video>();
        //        for (int i = 0; i < video_name.Length; i++)
        //        {
        //            P_Video videoItem = new P_Video()
        //            {
        //                P_Id = Guid.NewGuid().ToString(),
        //                P_VideoName = video_name[i].ToString().Trim(),
        //                P_Number = i,
        //                P_Status = 0,
        //                P_Url = video_url[i],
        //                P_VideoPic = video_url[i] == "" ? "" : video_url[i] + "?vframe/jpg/offset/0",
        //                P_VideoLength = Int32.Parse(video_length[i].ToString() == "" ? "0" : video_length[i].ToString()),
        //                P_CreateTime = DateTime.Now,
        //                P_CreateUser = GetAdminInfo().role_id.ToString()
        //            };
        //            video.Add(videoItem);
        //        }
        //        if (video.Count > 0)
        ...
        //            return;
        //        }
        //        JscriptMsg("修改信息成功！", "party_committee_notify_list.aspx?channel_id=" + this.channel_id);
        //    }
        //    else //添加
        //    {
        ...
        //            return;
        //        }
        //        JscriptMsg("添加信息成功！", "party_committee_notify_list.aspx?channel_id=" + this.channel_id);
        //    }
        //}
        ...
        //[WebMethod]
        //public static void DeleteQiNiuFileFun(string filename)
        //{
        //    try
        //    {
        ...
        //        new QiNiu().DeleteQiNiuFile(filename);
