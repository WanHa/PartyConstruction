...
{
    public partial class onlinelearnning_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("onlinelearnning_list.aspx", "keywords={0}&page={1}",this.keywords, "__id__");
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and (P_LearnUrl like  '%" + _keywords + "%')");
            }
        ...
        {
            //Response.Redirect(Utils.CombUrlTxt("onlinelearnning_list.aspx", "&keywords={0}", txtKeywords.Text));
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    Model.P_OnlineLearn model = bll.GetModel(id);
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！",
                Utils.CombUrlTxt("onlinelearnning_list.aspx", "keywords={0}", this.keywords), "parent.loadMenuTree");
        }
