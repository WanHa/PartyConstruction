...
{
    public partial class reviewactivity_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            BLL.P_ReviewActivity bll = new BLL.P_ReviewActivity();
            this.rptList.DataSource = bll.GetList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
            this.rptList.DataBind();

            //绑定页码
            txtPageNum.Text = this.pageSize.ToString();
            string pageUrl = Utils.CombUrlTxt("reviewactivity_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    Model.P_ReviewActivity model = bll.GetModel(id);
            ...
            AddAdminLog(DTEnums.ActionEnum.Delete.ToString(), "删除评选活动成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！",
                Utils.CombUrlTxt("reviewactivity_list.aspx", "keywords={0}", this.keywords), "parent.loadMenuTree");
        }
        #endregion
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("reviewactivity_list.aspx", "site_id={0}&keywords={1}", this.site_id.ToString(), this.keywords));
        }
        protected void GetReview(object sender, EventArgs e)
        {
            Publish: string id = DTRequest.GetQueryString("id");
        }
