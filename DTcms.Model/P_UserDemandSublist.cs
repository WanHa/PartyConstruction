...
{
    public class P_UserDemandSublist
    {
        public P_UserDemandSublist()
        { }
        private string _P_ID;
        private string _P_UDId;
        private string _P_Verifier;
        ...
        private int _P_UrgentStatus;

        public string P_ID { get => _P_ID; set => _P_ID = value; }
        public string P_UDId { get => _P_UDId; set => _P_UDId = value; }
        public string P_Verifier { get => _P_Verifier; set => _P_Verifier = value; }
        ...
        public int P_UrgentStatus { get => _P_UrgentStatus; set => _P_UrgentStatus = value; }
    }
}
