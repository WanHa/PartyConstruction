...
{
    public class P_EntitledGroupsInfo
    {
        public P_EntitledGroupsInfo()
        { }
        private string _P_Id;
        private string _P_EntitledGroups;
        ...
        public string P_EntitledGroups { get => _P_EntitledGroups; set => _P_EntitledGroups = value; }
