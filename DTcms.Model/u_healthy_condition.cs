...
{
    public class u_healthy_condition
    {
        public u_healthy_condition()
        { }
        private string _id;
        ...
        public string disease_info { get => _disease_info; set => _disease_info = value; }
    }
}
